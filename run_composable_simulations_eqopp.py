...
import make_one_composable_simulation_eqopp
...
def parse_args():
    ...
    parser.add_argument("--params_file", type=str, default="experimental_setups/simulation_composable_eo.json", help="Path to JSON file with parameters on which simulations to run")
